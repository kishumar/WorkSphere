import { AnimatePresence, easeOut, scale } from 'motion/react'
  ...
  return (
    ...
    backdrop-blur-xl px-4"
        ...
        shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
              ...
              />
              <button className='absolute top-5 right-5 z-20 text-zinc-400 hover:text-white transition 
            text-lg' onClick={onClose}>
                X
              </button>
              <div className='relative px-8 pt-14 pb-10  text-centre'>
                <h1 className='inline-block mb-6 px-4 py-1.5 rounded-full bg-white/5 border
                 border-white/10 text-xs text-zinc-300'> AI-powered website builder</h1>
       ...
       <span>WorkSphere</span>
         ...
         className='group relative w-full h-13 rounded-xl bg-white text-black 
         font-semibold shadow-xl overflow-hidden'>
          <div className='relative flex item-centre justify-center gsp-3'>
            <img src='https://tse4.mm.bing.net/th/id/OIP.HgH-NjiOdFOrkmwjsZCCfAHaHl?pid=Api&P=0&h=180' className='h-6 mr-2 text-md font-medium w-6'/>
