    ...
    <div className="min-h-screen bg-[#050505] text-white">
      <div className="sticky top-0 z-40 backdrop:blur-xl bg-black/50 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <button
            className="px-4 py-2 rounded-lg bg-white text-sm text-black font-semibold hover:scale-105"
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        {website?.length == 0 && (
          <div className="mt-24 text-center text-zinc-400">
            No website have been created yet{" "}
          </div>
        )}
    ...
    overflow-hidden hover:bg-white/10 transition flex flex-col"
                >
                  <div className="relative h-40 bg-black cursor-pointer">
                    <iframe
                      srcDoc={w.latestCode}
                      className="absolute inset-0 w-[140%]
    h-[140%] scale-[0.73] origin-top-left pointer-events-none bg-white"
                    />
       ...
       rounded-xl text-sm font-semibold bg-gradient-to-r from-indigo-500 to-purple-500 hover:scale-105 transition"
                      >
                        <Rocket size={18} />
                        Deploy
                      </button>
