...
function Generate() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#050505] via-[#0b0b0b] to-[#050505] text-white">
      <div className="sticky top-0 z-40 backdrop:blur-xl bg-black/50 border-b border-white/20">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold">
              WorkSphere<span className="text-zinc-400">.ai</span>
            </h1>
          </div>
        </div>
      </div>
      <div className="max-w-6xl mx-auto px-6 py-16 ">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">
            This process may take several minutes. worksphere.ai focuses on
            quality, not shortcuts.
          </p>
        </motion.div>
        <div className="mb-14">
          <h1 className="text-xl font-semibold mb-2">
            Describe your prompt or website
          </h1>
          <div className="relative">
            <textarea
              value={prompt}
              onChange={(e) => setPrompt(e.target.value)}
              placeholder=" Type your website in detail... "
              className="w-full h-56 p-6 rounded-3xl bg-white/3  border-white/10 outline-none
            resize-none text-sm leading-relaxed focus:ring-2 focus:ring-white/30"
            ></textarea>
          </div>
        ...
        {loading && (
          ...
          >
            ...
            <div className="text-center text-xs text-zinc-400 mt-4">
              ...
              <span className="text-white font-medium">~3-2 minutes</span>
            </div>
          </motion.div>
        )}
      </div>
