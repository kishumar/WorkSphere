...
const plans = [
  ...
  },
  {
    ...
    price: "₹499",
    credits: "500",
    description: "For serious creator & freelancers",
    features: [
      " Everything in Free",
      "Faster generation",
      "Edit & regenerate",
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-40 -left-40 right-0 w-[500px] h-[500px] bg-indigo-600/20 rounded-full blur-[120px]" />
         ...
         <ul className="space-y-3 mb-10">
           ...
           className="flex items-center gap-2 text-sm text-zinc-300">
            ...
            className={`w-full py-3 rounded-xl font-semibold transition
             ${p.popular ? "bg-indigo-500 hover:bg-indigo-600" 
